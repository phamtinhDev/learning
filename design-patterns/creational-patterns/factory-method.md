...
1. **Product:** khai báo interface chung cho tất cả các objects có thể được tạo ra bởi người tạo và các subclasses của nó.
...
4. Xử lý Các Loại Sản phẩm Khác nhau
